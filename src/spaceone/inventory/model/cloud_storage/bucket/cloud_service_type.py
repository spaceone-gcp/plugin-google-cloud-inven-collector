...
cst_bucket._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source(
            "Lifecycle rules", "data.lifecycle_rule.lifecycle_rule_display"
        ),
        EnumDyField.data_source(
            "Requester Pays",
            "data.requester_pays",
        ...
        # is_optional - Default
        TextDyField.data_source(
            "Link URL", "data.links.link_url", options={"is_optional": True}
        ),
        TextDyField.data_source(
    ...
    search=[
        ...
        SearchField.set(
            name="Update Time", key="data.update_timestamp", data_type="datetime"
        ),
    ],
    widget=[
