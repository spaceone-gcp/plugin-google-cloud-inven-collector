...
from spaceone.inventory.model.networking.route.cloud_service_type import (
    CLOUD_SERVICE_TYPES,
)
from spaceone.inventory.model.networking.route.cloud_service import (
    RouteResource,
    RouteResponse,
)
