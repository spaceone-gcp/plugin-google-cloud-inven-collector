...
vpc_network_route_meta = TableDynamicLayout.set_fields(
    "Routes",
    root_path="data.route_data.route",
    fields=[
        TextDyField.data_source("Name", "name"),
...
vpc_network_peering_meta = TableDynamicLayout.set_fields(
    "VPC Network Peering",
