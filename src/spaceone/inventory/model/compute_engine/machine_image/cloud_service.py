...
from spaceone.inventory.model.compute_engine.machine_image.data import MachineImage
...
meta_machine_template = ListDynamicLayout.set_layouts(
    "Machine Images", layouts=[meta_machine_image, meta_available_policy]
)


# TAB - Disk
# instance_template_meta_disk
it_meta_disk = TableDynamicLayout.set_fields(
    "Disks",
