...
lb_forwarding_rule = TableDynamicLayout.set_fields(
    "Forwarding Rule",
    root_path="data.forwarding_rules",
    fields=[
...
lb_target_proxy = ItemDynamicLayout.set_fields(
    "Target Proxy",
...
lb_certificate = TableDynamicLayout.set_fields(
    ...
    fields=[
        ...
        EnumDyField.data_source(
            ...
            default_badge={"indigo.500": ["SELF_MANAGED"], "coral.600": ["MANAGED"]},
        ),
        TextDyField.data_source("Description", "description"),
        TextDyField.data_source("Certificate", "certificate"),
        ListDyField.data_source(
            "Subnect Alternative Name", "subject_alternative_names"
        ),
...
lb_backend_service = TableDynamicLayout.set_fields(
    "Backend Service",
    root_path="data.backend_services",
    fields=[
        TextDyField.data_source("ID", "id"),
        TextDyField.data_source("Name", "name"),
        TextDyField.data_source("Description", "description"),
...
lb_backend_buckets = TableDynamicLayout.set_fields(
    "Backend Bucket",
    root_path="data.backend_buckets",
    fields=[
        TextDyField.data_source("Id", "id"),
        TextDyField.data_source("Name", "name"),
        TextDyField.data_source("Description", "description"),
...
lb_target_pools = TableDynamicLayout.set_fields(
    "Target Pool",
    root_path="data.target_pools",
    fields=[
        TextDyField.data_source("Id", "id"),
        TextDyField.data_source("Name", "name"),
        TextDyField.data_source("Description", "description"),
...
lb_legacy_health_checks = TableDynamicLayout.set_fields(
    "Legacy Health Check",
    root_path="data.legacy_health_checks",
    fields=[
        TextDyField.data_source("Id", "id"),
        TextDyField.data_source("Name", "name"),
        TextDyField.data_source("Description", "description"),
...
load_balancing_meta = CloudServiceMeta.set_layouts(
    [
        lb_forwarding_rule,
        lb_target_proxy,
        lb_routing_table,
...
class LoadBalancingResource(LoadBalancingResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=load_balancing_meta, serialized_name="metadata"
    )
