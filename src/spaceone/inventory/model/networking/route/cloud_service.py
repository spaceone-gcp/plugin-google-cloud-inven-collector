...
from spaceone.inventory.model.networking.route.data import *
...
route_applicable_inst_meta = TableDynamicLayout.set_fields(
...
instance_template_meta = CloudServiceMeta.set_layouts(
    [route_detail_meta, route_applicable_inst_meta]
)
