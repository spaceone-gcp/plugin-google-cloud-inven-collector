...
cst_gke_cluster._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source("Total Nodes", "data.current_node_count"),
        TextDyField.data_source("Total vCPU", "data.total_cpu"),
        TextDyField.data_source("Total Memory (MB)", "data.total_memory_mb"),
    ...
    search=[
        ...
        SearchField.set(name="Total CPU", key="data.total_cpu"),
        SearchField.set(name="Total Memory", key="data.total_memory_mb"),
